...
CKEDITOR_5_CONFIGS = {
    ...
    'extends': {
        ...
        'toolbar': ['heading', '|', 'outdent', 'indent', '|', 'bold', 'italic', 'link', 'underline', 'strikethrough', 'superscript', 'subscript',
        ...
        # אישור גורף לשמירת תגיות HTML ומאפיינים (עבור הערות שוליים, קישורי עוגן וכו')
        'htmlSupport': {
            'allow': [
